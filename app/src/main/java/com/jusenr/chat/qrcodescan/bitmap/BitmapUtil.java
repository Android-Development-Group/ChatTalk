package com.jusenr.chat.qrcodescan.bitmap;
...
public final class BitmapUtil {
    ...
    public static Bitmap getBitmapFormUri(Context context, Uri uri) {
        ...
        try {
            input1 = context.getContentResolver().openInputStream(uri);
            ...
            Bitmap bitmap = BitmapFactory.decodeStream(input2, null, bitmapOptions);
