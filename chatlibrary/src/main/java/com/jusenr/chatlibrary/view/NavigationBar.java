...
public class NavigationBar extends RelativeLayout {
    ...
    public void setMainTitle(String title) {
        ...
        if (mMainTitleSize != -1)
            mMainView.setTextSize(TypedValue.COMPLEX_UNIT_PX, mMainTitleSize);
    }
    ...
    public void setLeftTitle(String title) {
        ...
        if (mLeftView instanceof TextView) {
            ...
            if (mLeftTitleSize != -1)
                ((TextView) mLeftView).setTextSize(TypedValue.COMPLEX_UNIT_PX, mLeftTitleSize);
        }
    }
    ...
    public void setRightTitle(String title) {
        ...
        if (mRightView instanceof TextView) {
            ...
            if (mRightTitleSize != -1)
                ((TextView) mRightView).setTextSize(TypedValue.COMPLEX_UNIT_PX, mRightTitleSize);
        }
    }
